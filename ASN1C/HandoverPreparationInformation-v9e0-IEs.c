...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_3 = {
	sizeof(struct HandoverPreparationInformation_v9e0_IEs__nonCriticalExtension),
	offsetof(struct HandoverPreparationInformation_v9e0_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
