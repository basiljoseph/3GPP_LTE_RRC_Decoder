...
static asn_TYPE_member_t asn_MBR_MobilityControlInfo_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MobilityControlInfo, rach_ConfigDedicated),
	...
	{ ATF_POINTER, 1, offsetof(struct MobilityControlInfo, carrierFreq_v9e0),
...
static const int asn_MAP_MobilityControlInfo_oms_1[] = { 1, 2, 3, 7, 8 };
